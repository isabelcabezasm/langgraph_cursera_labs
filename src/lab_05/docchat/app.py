...
EXAMPLES = {
    ...
    "DeepSeek-R1 Technical Report": {
        ...
        "file_paths": ["examples/DeepSeek_Technical_Report.pdf"],
    },
}
...
def main():
    ...
    with gr.Blocks(
        ...
        gr.Markdown(
            "📤 Upload your document(s), enter your query then press Submit 📝",
            elem_classes="text",
        )
        gr.Markdown(
            "Or you can select one of the examples from the drop-down menu, select Load Example then press Submit 📝",
            elem_classes="text",
        )
        gr.Markdown(
