...
class TestRetrieverBuilder(unittest.TestCase):
    ...
    def test_embeddings_configuration(self):
        ...
        self.assertTrue(hasattr(embeddings, 'azure_endpoint') or hasattr(embeddings, 'openai_api_base'))
    ...
    def test_build_hybrid_retriever_with_sample_documents(self):
        ...
        with patch('retriever.builder.Chroma') as mock_chroma, \
    ...
    def test_retriever_functionality(self):
        ...
        print(f"✅ Retriever functionality test passed - found {len(results)} documents")
    ...
    def test_retriever_k_parameter(self):
        ...
        for k in [2, 5, 10]:
            with patch('retriever.builder.settings') as mock_settings, \
                ...
                self.assertLessEqual(len(results), k * 2)  # *2 because ensemble combines two retrievers
    ...
    def test_retriever_performance(self):
        ...
        print(f"✅ Performance test passed - {len(queries)} queries in {total_time:.2f} seconds")
